          ...
          <div className="row">
            <div className="col-md-6">
              <div className="content-block">
                ...
                <ul>
                  <li>
                    <i className="fa fa-caret-right"></i>vitae laboriosam
                    explicabo eligendi sapiente
                  </li>
                  <li>
                    <i className="fa fa-caret-right"></i>consectetur adipisicing
                    elit. Beatae
                  </li>
                  <li>
                    <i className="fa fa-caret-right"></i>dolorum esse tempora id
                    architecto
                  </li>
                  <li>
                    <i className="fa fa-caret-right"></i>optio repellendus quasi
                    nisi vitae
                  </li>
                </ul>
            ...
            <div className="service-box col-md-12">
              <div className="row">
                <div className="col-md-6">
                  <img
                ...
                <div className="col-md-6">
                  <div className="contents">
                    ...
                    <ul className="content-list">
                      <li>
                        <i className="fa fa-check-circle-o"></i>Whitening is
                        among the most popular dental
                      </li>
                      <li>
                        <i className="fa fa-check-circle-o"></i>Teeth cleaning
